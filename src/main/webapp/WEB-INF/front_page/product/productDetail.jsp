...
<div class="w ofc mt">
	...
	<div class="r" style="width: 640px">
		...
		<ul class="uls form">
			...
			<li id="hili2" onclick="buy()"><label>我 要 买：</label>
			...
			<li id="hili1" class="submit"><input type="button" value="" class="hand btn138x40" onclick="buy();"/><input type="button" value="" class="hand btn138x40b" onclick="addCart()"/></li>
		</ul>
	</div>
</div>
<div class="w ofc mt" >
