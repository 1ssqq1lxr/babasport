...
<div class="body-box" style="float:right">
	<form id="jvForm" action="addAll.do" method="post" enctype="multipart/form-data">
			...
			<tbody id="tab_1">
					...
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						商品类型:</td><td width="80%" class="pn-fcontent">
								<select name="typeId">
									...
									<option value="${ty.tid }">${ty.name }</option>
									</c:forEach>
								</select>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						材质:</td><td width="80%" class="pn-fcontent">
									<c:forEach items="${feature }" var="f">
										<input type="checkbox" value="${f.fid }" name="feature"/>${f.name }
									</c:forEach>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<c:forEach items="${color }" var="f">
								<input type="checkbox" value="${f.cid }" name="color"/>${f.name }
						</c:forEach>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<img width="100" id="allImgUrl" height="100" />
