...
<#if errors??>
	...
	<#list errors as error><li>${error}</li></#list>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="5">
                    <tr>
                      <td width="91" height="40" align="right"></td>
                      <td width="211"><input type="input" id="username" name="username"  maxlength="100" class="input"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input name="captcha" type="text" id="captcha"  class="input"/></td>
                    </tr>
